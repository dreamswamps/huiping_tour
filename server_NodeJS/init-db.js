...
(async () => {
  ...
  try {
    ...
    const inserts = [
      [
        "spots",
        "(title, description, image, category, location) VALUES ('井冈山革命博物馆', '中国第一个农村革命根据地', '/img/banner1.svg', '红色景点', '江西省吉安市')",
      ],
      [
        "spots",
        "(title, description, image, category, location) VALUES ('南昌起义纪念馆', '中国人民解放军诞生地', '/img/16.svg', '红色景点', '江西省南昌市')",
      ],
      [
        "products",
        "(name, description, price, original_price, image, stock) VALUES ('红色记忆纪念册', '精美红色文化纪念册', 39.90, 59.90, '/img/17.svg', 100)",
      ],
      [
        "products",
        "(name, description, price, original_price, image, stock) VALUES ('井冈山文创书签', '特色金属书签一套', 19.90, 29.90, '/img/18.svg', 200)",
      ],
      [
        "badges",
        "(name, icon, description, condition_text, sort_order) VALUES ('红色先锋', '/img/1.svg', '完成首次打卡', '首次访问任一景点', 1)",
      ],
      [
        "badges",
        "(name, icon, description, condition_text, sort_order) VALUES ('薪火传人', '/img/2.svg', '累计打卡5个景点', '打卡5个不同景点', 2)",
      ],
    ];
