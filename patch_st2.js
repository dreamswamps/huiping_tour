...
wxml = wxml.replace('class="red-card"', 'class="red-card {{isPlaying ? \'playing\' : \'\'}}"');
wxml = wxml.replace('bindtap="onAnimationPlay"', 'bindtap="onPlayRadio"');
wxml = wxml.replace('src="{{svgsUrl}}/svgs/svgs/station2-play-arrow.svg"', 'src="{{isPlaying ? svgsUrl + \'/svgs/svgs/station2-pause.svg\' : svgsUrl + \'/svgs/svgs/station2-play-arrow.svg\'}}"');
