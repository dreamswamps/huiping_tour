...
[4, 5].forEach((id) => {
  ...
  if (onLoadEnd > 0 && !js.includes("createInnerAudioContext")) {
    let audioLines = [
      '    this.setData({ audioSrc: config.svgsUrl + "/media/' +
        sid +
        '.MP3" });',
