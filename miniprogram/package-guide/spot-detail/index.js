const SPOT_DATA = {
  ...
  老红军故居: {
    ...
    body: "村内保留多处当年红军指战员长期居住的夯土老民居，完整复原游击时期红军生活原貌。屋内留存红军当年使用过的土灶、木板床、草鞋、旧农具、简易作战背包复刻展品，墙面保留红军标语痕迹，真实还原缺衣少食、靠山宿营的艰苦游击日常。例如，保留较为完好的黄华炳故居：黄华炳是灰坪乡上坪田村人。1936年10月至1937年2月任上坪田支部书记。1937年1月底，反动派对千里岗地区实施围剿，他被迫外迁。1937年4月9日被捕，关押在安徽休宁监狱。1941年，黄华炳被释放回到家乡。1987年12月病故，终年75岁。",
  },
  朱法祠: {
  ...
  红军秘密联络处旧址: {
    img: "",
    body: "深藏上坪田村古民居之中，是当年千里岗地下交通线上至关重要的情报中转站。在国民党封锁围剿的艰难环境下，各地游击队员、地下党员以普通农户身份为掩护，在此秘密传递军事情报、交接物资、短暂隐蔽休整，串联起衢江、淳安、寿昌三地游击队伍。",
  },
  上坪田乡愁文化长廊: {
    img: "",
    body: "沿村内主干道打造的慢行文化长廊，全长数百米，墙面分段设置图文展板，分为两大展示板块。第一板块记录上坪田村百年村落变迁、农耕民俗、乡土乡愁；第二板块完整梳理千里岗红军游击发展史，搭配老照片、文字小故事、红军人物简介。",
  },
  红色千里岗景区: {
    img: "",
    body: "广袤的千里岗山区构成浙西规模最大、体系最完整的革命游击根据地，山体横跨衢江灰坪、淳安、寿昌三大区域，红色遗迹星罗棋布分布山野之间。",
  },
};
