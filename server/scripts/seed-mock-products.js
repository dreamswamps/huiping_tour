...
const ITEMS = [
  {
    ...
    images: ['http://localhost:3000/img/turn-1.jpg', 'http://localhost:3000/img/turn-2.jpg'],
    content:
  ...
  },
  {
    ...
    images: ['http://localhost:3000/img/turn-2.jpg', 'http://localhost:3000/img/turn-3.png'],
    content: '<p>玻璃杯或盖碗均可；水温约 80～85℃，不宜久闷，以免涩感加重。</p>',
  ...
  },
  {
    ...
    images: ['http://localhost:3000/img/turn-3.png', 'http://localhost:3000/img/turn-4.png'],
  ...
  },
  {
    ...
    images: ['http://localhost:3000/img/turn-4.png', 'http://localhost:3000/img/turn-1.jpg'],
  ...
  try {
    for (const it of ITEMS) {
      ...
      for (const row of rows) {
        await conn.query('DELETE FROM product_details WHERE product_id = ?', [row.id]);
